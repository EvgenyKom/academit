...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Столбец по индексу 1 в матрице 3 : " + matrix3.getColumn(2).toString());
        ...
        System.out.println("Произведение матрицы 5 на ее столбец с индексом 2 :" + matrix5.multiplyByVector(matrix5.getRow(2)));
